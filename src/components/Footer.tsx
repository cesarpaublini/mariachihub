        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/how-it-works" className="text-gray-300 hover:text-red-400 transition-colors">
                  How It Works
                </Link>
              </li>
              <li>
                <Link href="/tampa" className="text-gray-300 hover:text-red-400 transition-colors">
                  Tampa
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/book" className="text-gray-300 hover:text-red-400 transition-colors">
                  Book Now
                </Link>
              </li>
